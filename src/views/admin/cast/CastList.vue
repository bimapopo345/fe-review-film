<template>
    <div class="cast-list">
        ...
        <div v-else class="cast-grid">
            <div v-for="cast in castList" :key="cast.id" class="cast-card">
                <img
                ...
                <div class="cast-info">
                    ...
                    <div class="action-buttons">
                        <button @click="editCast(cast)" class="edit-btn">
                            Edit
                        </button>
        ...
        >
            <div class="modal-content" @click.stop>
                ...
                <p>
                    Are you sure you want to delete "{{ castToDelete?.name }}"?
                </p>
                <div class="modal-actions">
                    <button
                        @click="deleteCast"
